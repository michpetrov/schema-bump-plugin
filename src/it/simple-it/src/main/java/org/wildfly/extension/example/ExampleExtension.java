...
package org.wildfly.extension.example;
...
public class ExampleExtension implements Extension {
    ...
    private static final ExampleSubsystemParser_17_0 CURRENT_PARSER = new ExampleSubsystemParser_17_0();
    ...
    public void initialize(ExtensionContext context) {
        ...
        // Root resource
        final ManagementResourceRegistration subsystem = subsystemRegistration.registerSubsystemModel(new ExampleSubsystemRootResourceDefinition(broadcastCommandDispatcherFactoryInstaller));
    ...
    public void initializeParsers(ExtensionParsingContext context) {
        ...
        context.setSubsystemXmlMapping(SUBSYSTEM_NAME, ExampleSubsystemParser_1_0.NAMESPACE, ExampleSubsystemParser_1_0::new);
        context.setSubsystemXmlMapping(SUBSYSTEM_NAME, ExampleSubsystemParser_2_0.NAMESPACE, ExampleSubsystemParser_2_0::new);
        context.setSubsystemXmlMapping(SUBSYSTEM_NAME, ExampleSubsystemParser_3_0.NAMESPACE, ExampleSubsystemParser_3_0::new);
        context.setSubsystemXmlMapping(SUBSYSTEM_NAME, ExampleSubsystemParser_4_0.NAMESPACE, ExampleSubsystemParser_4_0::new);
        context.setSubsystemXmlMapping(SUBSYSTEM_NAME, ExampleSubsystemParser_5_0.NAMESPACE, ExampleSubsystemParser_5_0::new);
        context.setSubsystemXmlMapping(SUBSYSTEM_NAME, ExampleSubsystemParser_6_0.NAMESPACE, ExampleSubsystemParser_6_0::new);
        context.setSubsystemXmlMapping(SUBSYSTEM_NAME, ExampleSubsystemParser_7_0.NAMESPACE, ExampleSubsystemParser_7_0::new);
        context.setSubsystemXmlMapping(SUBSYSTEM_NAME, ExampleSubsystemParser_8_0.NAMESPACE, ExampleSubsystemParser_8_0::new);
        context.setSubsystemXmlMapping(SUBSYSTEM_NAME, ExampleSubsystemParser_9_0.NAMESPACE, ExampleSubsystemParser_9_0::new);
        context.setSubsystemXmlMapping(SUBSYSTEM_NAME, ExampleSubsystemParser_10_0.NAMESPACE, ExampleSubsystemParser_10_0::new);
        context.setSubsystemXmlMapping(SUBSYSTEM_NAME, ExampleSubsystemParser_11_0.NAMESPACE, ExampleSubsystemParser_11_0::new);
        context.setSubsystemXmlMapping(SUBSYSTEM_NAME, ExampleSubsystemParser_12_0.NAMESPACE, ExampleSubsystemParser_12_0::new);
        context.setSubsystemXmlMapping(SUBSYSTEM_NAME, ExampleSubsystemParser_13_0.NAMESPACE, ExampleSubsystemParser_13_0::new);
        context.setSubsystemXmlMapping(SUBSYSTEM_NAME, ExampleSubsystemParser_13_1.NAMESPACE, ExampleSubsystemParser_13_1::new);
        context.setSubsystemXmlMapping(SUBSYSTEM_NAME, ExampleSubsystemParser_14_0.NAMESPACE, ExampleSubsystemParser_14_0::new);
        context.setSubsystemXmlMapping(SUBSYSTEM_NAME, ExampleSubsystemParser_15_0.NAMESPACE, ExampleSubsystemParser_15_0::new);
        context.setSubsystemXmlMapping(SUBSYSTEM_NAME, ExampleSubsystemParser_16_0.NAMESPACE, ExampleSubsystemParser_16_0::new);
        context.setSubsystemXmlMapping(SUBSYSTEM_NAME, ExampleSubsystemParser_17_0.NAMESPACE, CURRENT_PARSER);
    }
}
